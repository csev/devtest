...
<li><a href="tail.php?file=<?= $CFG['sakaihome'] ?>/apache-tomcat-9.0.21/logs/catalina.out" target="_new">Tail catalina.out</a></li>
...
<li><input type="submit" name="tomcat_start" value="Start Tomcat"></li>
